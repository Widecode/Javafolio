package com.webdriver.alertPopUp;
...
import org.openqa.selenium.firefox.FirefoxDriver;
	...
	public class WindowAlert {
			...
			public void testWindowAlert() throws Exception{
				...
				driver.findElement(By.id("Email")).sendKeys("widevil@gmail.com");
 
				// enter a valid password
				driver.findElement(By.id("Passwd")).sendKeys("Naz#9@6!5");
				...
				driver.findElement(By.xpath("//div[@class='z0']//div[contains(text(),'Õ¿œ»—¿“»')]")).click();
